...
class TextInput:
    ...
    """
    def __init__(self, one_letter_input = False,
                        font_family = "",
                        font_size = 35,
                        antialias=True,
                        text_color=(0, 0, 0),
        ...
        # Text related vars:
        self._one_letter_input = one_letter_input
        ...
        for event in events:
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pl.K_BACKSPACE: # FIXME: Delete at beginning of line?
                    ...
                    # If we want one letter input
                    if self._one_letter_input and len(self.input_string) == 0:
                        self.input_string = self.input_string[:self.cursor_position] + \
                                            event.unicode + \
                                            self.input_string[self.cursor_position:]
